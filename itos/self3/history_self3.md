...
| Ver.1.1.1 | 2016/11/02 | ・いただいたボタンのリソース入れ替え<br> ・メニューのセルフ時数量入力不可設定時表示がお隠しなる場合があるのを修正<br>・会計画面の「お支払い」ボタンをとりあえず日本語環境で非表示<br> ・<<お試し>><br>　ご注文リストボタン(注文数に応じて点滅ON/OFF)（<a href="./histimage/1_1_1_1.gif">画像参照</a>）<br>　サムネイルでの注文ボタン点滅(注文数に関係なく点滅(暫定))（<a href="./histimage/1_1_1_2.gif">画像参照</a>）|

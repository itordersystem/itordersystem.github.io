...
| Ver.2.0.27 | 2018/04/16 | ・テーブル情報ウインドウにテーブル対応プリンタ設定を追加（<a href="./histimage/2_0_27_1.png">画像参照</a>）（<a href="./histimage/2_0_27_2.png">画像参照</a>）<br>　メニュー編集の出力先に「テーブル対応プリンタ」が設定されているメニューは注文元のテーブルに対応したプリンタに出力される |

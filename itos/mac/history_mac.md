...
| Ver.2.0.26 | 2018/04/12 | ・テーブル情報ウインドウにテーブル対応プリンタ設定を追加（<a href="./histimage/2_0_25_1.png">画像参照</a>）<br>　テーブル対応プリンタが設定されているテーブルからの注文は全てその設定されているプリンタに出力される。設定されていないテーブルは従来通り。|
